...
class events:
    ...
    def switch_event(self):
        ...
        config.read('/usr/local/pycalc/pycalc/src/config.ini')
        ...
        with open('/usr/local/pycalc/pycalc/src/config.ini', 'w') as config_file:
    ...
    def hist(self):
        ...
        if config.get('settings', 'history') == "True":
            ...
            number_rows = 9
            with open('/usr/local/pycalc/pycalc/src/log/history.csv', "r") as file:
...
class PyCalc(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        time_image=customtkinter.CTkImage(
            light_image=Image.open("/usr/local/pycalc/pycalc/src/images/time-past.png"),
            dark_image=Image.open("/usr/local/pycalc/pycalc/src/images/time-past.png"),
            size=(15, 15)
        )

        menu_image=customtkinter.CTkImage(
            light_image=Image.open("/usr/local/pycalc/pycalc/src/images/menu-burger.png"),
            dark_image=Image.open("/usr/local/pycalc/pycalc/src/images/menu-burger.png"),
            size=(15, 15)
        )

        heart_image=customtkinter.CTkImage(
            light_image=Image.open("/usr/local/pycalc/pycalc/src/images/heart.png"),
            dark_image=Image.open("/usr/local/pycalc/pycalc/src/images/heart.png"),
            size=(15, 15)
        )

        settings_image=customtkinter.CTkImage(
            light_image=Image.open("/usr/local/pycalc/pycalc/src/images/settings-sliders.png"),
            dark_image=Image.open("/usr/local/pycalc/pycalc/src/images/settings-sliders.png"),
            size=(15, 15)
        )

        delete_image=customtkinter.CTkImage(
            light_image=Image.open("/usr/local/pycalc/pycalc/src/images/delete.png"),
            dark_image=Image.open("/usr/local/pycalc/pycalc/src/images/delete.png"),
            size=(20, 20)
        )

        divide_image=customtkinter.CTkImage(
            light_image=Image.open("/usr/local/pycalc/pycalc/src/images/divide.png"),
            dark_image=Image.open("/usr/local/pycalc/pycalc/src/images/divide.png"),
            size=(15, 15)
        )

        cross_image=customtkinter.CTkImage(
            light_image=Image.open("/usr/local/pycalc/pycalc/src/images/cross-small.png"),
            dark_image=Image.open("/usr/local/pycalc/pycalc/src/images/cross-small.png"),
            size=(20, 20)
        )

        plus_image=customtkinter.CTkImage(
            light_image=Image.open("/usr/local/pycalc/pycalc/src/images/plus-small.png"),
            dark_image=Image.open("/usr/local/pycalc/pycalc/src/images/plus-small.png"),
            size=(20, 20)
        )

        minus_image=customtkinter.CTkImage(
            light_image=Image.open("/usr/local/pycalc/pycalc/src/images/minus-small.png"),
            dark_image=Image.open("/usr/local/pycalc/pycalc/src/images/minus-small.png"),
            size=(20, 20)
        )

        self.unlock_image=customtkinter.CTkImage(
            light_image=Image.open("/usr/local/pycalc/pycalc/src/images/arrow-down-right-from-square.png"),
            dark_image=Image.open("/usr/local/pycalc/pycalc/src/images/arrow-down-right-from-square.png"),
            size=(15, 15)
        )

        self.lock_image=customtkinter.CTkImage(
            light_image=Image.open("/usr/local/pycalc/pycalc/src/images/arrow-up-right-from-square.png"),
            dark_image=Image.open("/usr/local/pycalc/pycalc/src/images/arrow-up-right-from-square.png"),
            size=(15, 15)
        )
